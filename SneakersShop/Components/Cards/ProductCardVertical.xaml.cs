...
public partial class ProductCardVertical : ContentView
{
    public static readonly BindableProperty ProductColorIdProperty =
        BindableProperty.Create(nameof(ProductColorId), typeof(int), typeof(ProductCardVertical), 0);

    public static readonly BindableProperty NameProperty =
        BindableProperty.Create(nameof(Name), typeof(string), typeof(ProductCardVertical), "");

    public static readonly BindableProperty BrandProperty =
        BindableProperty.Create(nameof(Brand), typeof(string), typeof(ProductCardVertical), "");

    public static readonly BindableProperty ImageProperty =
        BindableProperty.Create(nameof(Image), typeof(string), typeof(ProductCardVertical), "");

    public static readonly BindableProperty OldPriceProperty =
        BindableProperty.Create(nameof(OldPrice), typeof(decimal), typeof(ProductCardVertical), 0m);

    public static readonly BindableProperty NewPriceProperty =
        BindableProperty.Create(nameof(NewPrice), typeof(decimal), typeof(ProductCardVertical), 0m);

    public static readonly BindableProperty CountReviewProperty =
        BindableProperty.Create(nameof(CountReview), typeof(int), typeof(ProductCardVertical), 0);

    public static readonly BindableProperty AvgRatingProperty =
        BindableProperty.Create(nameof(AvgRating), typeof(decimal), typeof(ProductCardVertical), 0m);

    public static readonly BindableProperty HasDiscountProperty =
        BindableProperty.Create(nameof(HasDiscount), typeof(bool), typeof(ProductCardVertical), false);

    public static readonly BindableProperty TextColorProperty =
        BindableProperty.Create(nameof(TextColor), typeof(string), typeof(ProductCardVertical), "");
