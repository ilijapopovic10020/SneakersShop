...
public partial class ProductHorizontalVariantComponent : ContentView
{
    private readonly ProductService _productService = new();

    public static readonly BindableProperty ImageProperty =
        BindableProperty.Create(nameof(Image), typeof(string), typeof(ProductHorizontalVariantComponent), "");

    public static readonly BindableProperty BrandProperty =
        BindableProperty.Create(nameof(Brand), typeof(string), typeof(ProductHorizontalVariantComponent), "");

    public static readonly BindableProperty NameProperty =
        BindableProperty.Create(nameof(Name), typeof(string), typeof(ProductHorizontalVariantComponent), "");
    ...
    public static readonly BindableProperty AvgRatingProperty =
        BindableProperty.Create(nameof(AvgRating), typeof(decimal), typeof(ProductHorizontalVariantComponent), 0m);

    public static readonly BindableProperty CountReviewProperty =
        BindableProperty.Create(nameof(CountReview), typeof(int), typeof(ProductHorizontalVariantComponent), 0);

    public static readonly BindableProperty TextColorProperty =
        BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(ProductHorizontalVariantComponent), null);

    public static readonly BindableProperty DiscountTypeProperty =
        BindableProperty.Create(nameof(DiscountType), typeof(string), typeof(ProductHorizontalVariantComponent), "");
    ...
    public static readonly BindableProperty ProductIdProperty =
        BindableProperty.Create(nameof(ProductId), typeof(int), typeof(ProductHorizontalVariantComponent), 0);
    ...
    public ProductHorizontalVariantComponent()
	{
		InitializeComponent();
	}
